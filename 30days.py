...
def days30(page_id, timeframe='LAST_30_DAYS', output_file='30.json'):
    ...
    data = {
        ...
        'variables': f'{{"audienceTimeframe":"{timeframe}","viewAllPageID":"{page_id}"}}',
...
# Example usage:
# days30('248913988520756', timeframe='LAST_30_DAYS', output_file='facebook_ad_data.json')
# if result:
#     print(result)
